...
try:
    from armv7l.openvino.inference_engine import IENetwork, IEPlugin, IECore
except:
...
def build_argparser():
    ...
    args.add_argument("-i", "--input",
                      ...
                      required=True,default="cam", type=str)
...
def main():
    ...
    # model_xml = "/home/pi/Desktop/ssd_mobilenet_v1_ssd/pedestrian-detection-adas-0002.xml"
