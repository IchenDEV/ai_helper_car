...
def main():
    ...
    predicted_dir_path = 'mAP/'+file_name+'_async/predicted'
    ...
    # print("start:",start)
    with open("/home/pi/Desktop/MobileNet-SSD/VOCdevkit/2007_test_2098.txt", 'r') as annotation_file:
        frame=annotation_file.readline()
    with open("/home/pi/Desktop/MobileNet-SSD/VOCdevkit/2007_test_2098.txt", 'r') as annotation_file:
        for num, line in enumerate(annotation_file):
            next_frame=line
            
            next_image = cv2.imread(next_frame.strip().split()[0])

            annotation = frame.strip().split()
            ...
            in_frame= cv2.resize(next_image,(320,320))
